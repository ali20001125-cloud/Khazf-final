...
export const settings = pgTable("settings", {
  ...
  boxDiscountCap: integer("box_discount_cap").notNull().default(20000),
  homeCropsCount: integer("home_crops_count").notNull().default(10),
  homeBestsellerSlug: text("home_bestseller_slug"),  // سقف خصم البوكس
